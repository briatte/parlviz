<?php
  ...
  $box =
    '<p>This graph shows Icelandic Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $years . '. ' .
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_gr">
    ...
    <h1>icelandic parliament</h1>

    <h2>
      <a href="http://www.althingi.is/" title="Alþingi">
      <img src="logo_is.png" height="18" alt="logo"></a>&nbsp;
      Alþingi, <?php echo $y[ $years ]; ?>
    </h2>
    ...
    <footer>
      ...
      <!-- tweet -->
      <p>
        <a href="http://twitter.com/share?text=Cosponsorship%20networks%20in%20the%20@Althingi%20-%20Icelandic%20Parliament%20-%20using%20%23rstats%20and%20@sigmajs,%20by%20@phnk:&amp;url=<?php echo 'http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>" class="button" title="Share this page on Twitter."><i class="fa fa-twitter"></i>&nbsp;Tweet</a>&nbsp;&nbsp;
      ...
      <ul>
        ...
        <li>
          ...
          <a href="<?php echo 'net_is' . $years; ?>.gexf" title="Download this graph (GEXF, readable with Gephi)">network</a>&nbsp;&nbsp;
          <i class="fa fa-files-o"></i>&nbsp;&nbsp;
          <a href="net_is.zip" title="Download all graphs (GEXF, readable with Gephi)">full series</a>&nbsp;&nbsp;
