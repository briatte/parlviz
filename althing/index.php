<?php
  ...
  $box =
    '<p>This graph shows Icelandic Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $t . '. ' .
    ...
    <footer>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="<?php echo 'net_is' . $t; ?>.gexf" title="Download this graph (GEXF, readable with Gephi)">network</a>&nbsp;&nbsp;
