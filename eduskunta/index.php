<?php
  ...
  $box =
    '<p>This graph shows Finnish Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during the ' . $nth . '&nbsp;legislature. ' .
...
<head>
  <title>
    Cosponsorship networks in the Finnish Parliament, legislature
    <?php echo $t; ?>
  </title>
  <meta charset="utf-8">
    ...
    <footer>
      ...
      <div id="about">
        ...
        <ul>
          ...
          <!-- <li>Follow the links below to take a look at other parliaments.</li> -->
...
fillBox = function(x, y, z) {
  ...
  $.ajax({
    type: "GET",
    url: document.title.replace('Cosponsorship networks in the Finnish Parliament, legislature ', 'net_fi') + '.gexf',
    dataType: "xml",
...
sigma.parsers.gexf(
  document.title.replace('Cosponsorship networks in the Finnish Parliament, legislature ', 'net_fi') + '.gexf',
  ...
  function(s) {
    ...
    s.bind('clickNode', function(e) {
      ...
      var profile = '<a href="http://www.eduskunta.fi' + e.data.node.attributes['url'] +
        '" title="Go to profile (Eduskunta, new window)" target="_blank">';
