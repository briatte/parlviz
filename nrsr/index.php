<?php
  ...
  $box =
    '<p>This graph shows Slovakian Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $y[ $years ] . '. ' .
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_an">
    ...
    <h1>slovakian parliament</h1>

    <h2>
      <a href="http://www.nrsr.sk/" title="Národná rada">
      <img src="logo_sk.png" height="18" alt="logo"></a>&nbsp;
      Národná rada, <?php echo $y[ $years ]; ?>
    </h2>
    ...
    <footer>
      ...
      <!-- tweet -->
      <p>
        <a href="http://twitter.com/share?text=Cosponsorship%20networks%20in%20the%20Slovakian%20Parliament%20using%20%23rstats%20and%20@sigmajs,%20by%20@phnk:&amp;url=<?php echo 'http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>" class="button" title="Share this page on Twitter."><i class="fa fa-twitter"></i>&nbsp;Tweet</a>&nbsp;&nbsp;
      ...
      <ul>
        ...
        <li>
          ...
          <a href="<?php echo 'net_sk' . $years; ?>.gexf" title="Download this graph (GEXF, readable with Gephi)">network</a>&nbsp;&nbsp;
          <i class="fa fa-files-o"></i>&nbsp;&nbsp;
          <a href="net_sk.zip" title="Download all graphs (GEXF, readable with Gephi)">full series</a>&nbsp;&nbsp;
...
sigma.parsers.gexf(
  ...
  function(s) {
    ...
    // box
    var parties = [ 'Komunistická strana Slovenska', 'Strana demokratickej ľavice', 'Strana občianskeho porozumenia', 
