<?php
  ...
  $box =
    '<p>This graph shows Hungarian Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $y[ $years ] . '. ' .
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_gr">
    ...
    <footer>
      ...
      <!-- tweet -->
      <p>
        <a href="http://twitter.com/share?text=Cosponsorship%20networks%20in%20the%20Hungarian%20Parliament%20using%20%23rstats%20and%20@sigmajs,%20by%20@phnk:&amp;url=<?php echo 'http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>" class="button" title="Share this page on Twitter."><i class="fa fa-twitter"></i>&nbsp;Tweet</a>&nbsp;&nbsp;
      ...
      <ul>
        ...
        <li>
          ...
          <a href="<?php echo 'net_hu' . $years; ?>.gexf" title="Download this graph (GEXF, readable with Gephi)">network</a>&nbsp;&nbsp;
          <i class="fa fa-files-o"></i>&nbsp;&nbsp;
          <a href="net_hu.zip" title="Download all graphs (GEXF, readable with Gephi)">full series</a>&nbsp;&nbsp;
...
sigma.parsers.gexf(
  ...
  function(s) {
    ...
    // box
    var parties = [ 'Lehet Más a Politika', 'Magyar Szocialista Párt', 'Szabad Demokraták Szövetsége', 
      'Fidesz – Magyar Polgári Szövetség', 'Magyar Demokrata Fórum', 'Kereszténydemokrata Néppárt', 
      'Jobbik Magyarországért Mozgalom', 'Független Kisgazda, Földmunkás és Polgári Párt', 
      'Magyar Igazság és Élet Pártja', 'independent' ];
