<?php
  ...
  $box =
    '<p>This graph shows Bulgarian Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $y[ $years ] . '. ' .
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_an">
    ...
    <h2>
      ...
      &nbsp;Narodno Sabranie,&nbsp;<br><?php echo $y[ $years ]; ?>
    </h2>
  ...
  function(s) {
    ...
    s.bind('clickNode', function(e) {
      ...
      document.getElementById('box').innerHTML = '<p style="min-height: 150px; background:' + rgba + ';">' +
        ...
        constituency + ' who had <span title="unweighted total degree">' +
