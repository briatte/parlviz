<?php
  ...
  $box = '<p>This graph shows Danish Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years 2004&mdash;2014. ' .
      ...
      '<p>The graph includes only <a href="http://www.ft.dk/Leksikon/Lovforslag.aspx">bills</a> and ' .
      '<a href="http://www.ft.dk/Leksikon/Beslutningsforslag.aspx">motions</a>, ' .
      'mostly from opposition <abbr title="Members of Parliament">MPs</abbr>, plus a handful of bills cosponsored by ' .
      '<abbr title="Members of Parliament">MPs</abbr> from the government majority. ' .
      'It does not include nonbinding <a href="http://www.ft.dk/Leksikon/Forslag_til_vedtagelse.aspx">resolutions</a>.</p>' .
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_gr">
    ...
    <footer>
      ...
      <!-- tweet -->
      <p>
        <a href="http://twitter.com/share?text=Cosponsorship%20networks%20in%20the%20@Folketinget%20-%20Danish%20Parliament%20-%20using%20%23rstats%20and%20@sigmajs,%20by%20@phnk:&amp;url=<?php echo 'http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>" class="button" title="Share this page on Twitter."><i class="fa fa-twitter"></i>&nbsp;Tweet</a>&nbsp;&nbsp;
...
fillBox = function(x, y, z) {
  ...
  $.ajax({
    type: "GET",
    url: document.title.replace('Cosponsorship networks in the Danish Parliament: ', 'net_dk') + '.gexf',
    dataType: "xml",
...
sigma.parsers.gexf(
  document.title.replace('Cosponsorship networks in the Danish Parliament: ', 'net_dk') + '.gexf',
  ...
  function(s) {
    ...
    // box
    var parties = ['Enhedslisten', 'Socialistisk Folkeparti', 'Socialdemokratiet',
      'Radikale Venstre', 'Kristendemokraterne', 'Liberal Alliance',
      'Det Konservative Folkeparti', 'Venstre', 'Dansk Folkeparti',
      'Inuit Ataqatigiit', 'Siumut', 'Javnaðarflokkurin', 'Sambandsflokkurin',
      'Independent'];
    ...
    s.bind('clickNode', function(e) {
      ...
      // constituency
      var constituency = ' representing <a title="Look up on Wikipedia Dansk (new window)" target="_blank" href="https://da.wikipedia.org/wiki/' + 
