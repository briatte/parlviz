<?php
  ...
  $box =
    '<p>This graph shows Estonian Members of Parliament (<abbr title="Members of Parliament">MPs</abbr>) during years ' . $y[ $years ] . '. ' .
...
<head>
  <title>
    Cosponsorship networks in the Estonian Parliament, years
    <?php echo $years; ?>
  </title>
  <meta charset="utf-8">
...
<div id="sigma-container">
  ...
  <div id="controls" class="bg_an">
    ...
    <h1>estonian parliament</h1>

    <h2>
      <a href="http://www.riigikogu.ee/" title="Riigikogu">
      <img src="logo_ee.png" height="18" alt="logo"></a>&nbsp;
      Riigikogu, <?php echo $y[ $years ]; ?>
    </h2>
    ...
    <footer>
      ...
      <!-- tweet -->
      <p>
        <a href="http://twitter.com/share?text=Cosponsorship%20networks%20in%20the%20Estonian%20Parliament%20using%20%23rstats%20and%20@sigmajs,%20by%20@phnk:&amp;url=<?php echo 'http://' . $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"]; ?>" class="button" title="Share this page on Twitter."><i class="fa fa-twitter"></i>&nbsp;Tweet</a>&nbsp;&nbsp;
      ...
      <ul>
        <li>
          Data from
          <a href="http://www.riigikogu.ee/">riigikogu.ee</a>
          (winter 2015)
        </li>

        <li>
          Background photo by
          <a href="https://commons.wikimedia.org/wiki/File:Riigikogu_(2011).jpg" title="Original photograph by Rastrojo">Rastrojo</a>
          (Wikimedia)
        </li>
        ...
        <li>
          ...
          <a href="<?php echo 'net_ee' . $years; ?>.gexf" title="Download this graph (GEXF, readable with Gephi)">network</a>&nbsp;&nbsp;
          <i class="fa fa-files-o"></i>&nbsp;&nbsp;
          <a href="net_ee.zip" title="Download all graphs (GEXF, readable with Gephi)">full series</a>&nbsp;&nbsp;
...
fillBox = function(x, y, z) {
  ...
  $.ajax({
    type: "GET",
    url: document.title.replace('Cosponsorship networks in the Estonian Parliament, years ', 'net_ee') + '.gexf',
    dataType: "xml",
...
sigma.parsers.gexf(
  document.title.replace('Cosponsorship networks in the Estonian Parliament, years ', 'net_ee') + '.gexf',
  ...
  function(s) {
    ...
    s.bind('clickNode', function(e) {
      ...
      // profile
      var profile = '<a href="' + e.data.node.attributes['url'] + '" title="Go to profile (Estonian Parliament, new window)" target="_blank">';
